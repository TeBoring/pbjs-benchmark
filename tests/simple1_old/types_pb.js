 ...
 * @const
 */
proto.Test.repeatedFields_ = [5,6];
...
proto.Test.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    strsList: jspb.Message.getField(msg, 6)
  };
 ...
 * @return {!Array.<number>}
 */
proto.Test.prototype.getNumsList = function() {
  return /** @type {!Array.<number>} */ (jspb.Message.getField(this, 5));
};


/** @param {!Array.<number>} value */
proto.Test.prototype.setNumsList = function(value) {
 ...
 */
proto.Test.prototype.addNums = function(value, opt_index) {
  jspb.Message.addToRepeatedField(this, 5, value, opt_index);
};


proto.Test.prototype.clearNumsList = function() {
  this.setNumsList([]);
};
 ...
 * @return {!Array.<string>}
 */
proto.Test.prototype.getStrsList = function() {
  return /** @type {!Array.<string>} */ (jspb.Message.getField(this, 6));
};


/** @param {!Array.<string>} value */
proto.Test.prototype.setStrsList = function(value) {
 ...
 * @param {number=} opt_index
 */
proto.Test.prototype.addStrs = function(value, opt_index) {
  jspb.Message.addToRepeatedField(this, 6, value, opt_index);
};


proto.Test.prototype.clearStrsList = function() {
  this.setStrsList([]);
};
