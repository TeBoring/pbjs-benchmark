...
module.exports.deserializeBinary = function(a) {
  a = new fa(a);
...
module.exports.serializeBinary = function(a) {
  var b = new ja,
    c;
  c = x(a, 1, "");
  0 < c.length && ka(b, 1, c);
...
module.exports.deserializeText = function(a) {
  return new W(da(a))
};
module.exports.serializeText = function(a) {
  return a.h()
};
